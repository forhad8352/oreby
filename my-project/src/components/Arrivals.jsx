...
function SampleNextArrow(props) {
  ...
  return (
    <div
      className="absolute top-[40%] right-0 h-[50px] w-[50px] bg-gray-200 rounded-full text-center !leading-[50px] translate-y-[-40%]"
      onClick={onClick}
    >
...
function SamplePrevArrow(props) {
  ...
  return (
    <div
      className="absolute top-[40%] left-0 h-[50px] w-[50px] bg-gray-200 rounded-full text-center !leading-[50px] translate-y-[-40%] z-50"
      onClick={onClick}
    >
