        ...
        <div className="container mx-auto">
                <div className="flex items-center justify-between">
                        ...
                        <div className="w-[85%]">
                                ...
                                'top-[50px] left-0 bg-[#7e3939] w-full duration-700'
                                :'top-[50px] left-[-100%] w-full duration-700'}`}> 
                                        <li className=' font-dmfont lg:text-[#767676] text-[#000] font-medium text-[14px] hover:text-[#262626] hover:font-bold hover:duration-700 px-5 py-2 lg:py-0'>Home</li>
                                        <li className=' font-dmfont lg:text-[#767676] text-[#000] font-medium text-[14px] hover:text-[#262626] hover:font-bold hover:duration-700 px-5 py-2 lg:py-0'>Shop</li>
