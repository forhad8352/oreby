      ...
      <div className="w-[50%]">
        ...
        <div className=" py-[24px] border-b-[1px] border-[#F0F0F0]">
          ...
          <div className="flex justify-between items-center">
            <h4 className="font-dmfont text-[16px] font-bold">FEATURES  & DETAILS</h4>
            {show == true ? <span> <RxCross2 className="font-dmfont text-[18px] font-bold text-[#000]"/></span> : <span><FaPlus className="font-dmfont text-[16px] font-bold text-[#000]"/></span> }
          </div>
          {show &&
            <p className="text-[16px] text-[#767676] font-dmfont font-normal pt-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora maiores autem eius nisi. Repudiandae, dolores quisquam. Accusantium rem distinctio iusto ullam fuga? Quam deleniti nemo consectetur quis veniam quibusdam harum tempore neque dolorem, corrupti cupiditate eligendi accusantium, excepturi molestias fugiat.</p>
          }
          </div>
        </div>
        ...
        <div className=" py-[24px] border-b-[1px] border-[#F0F0F0]">
          ...
          <div className="flex justify-between items-center">
            <h4 className="font-dmfont text-[16px] font-bold">SHIPPING & RETURNS</h4>
           {showw == true ? <span> <RxCross2 className="font-dmfont text-[18px] font-bold text-[#000]"/></span> : <span><FaPlus className="font-dmfont text-[16px] font-bold text-[#000]"/></span> }  
          </div>
          {showw && 
            <p className="text-[16px] text-[#767676] font-dmfont font-normal pt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quo quidem veritatis ab vel porro dolorem quasi nemo, tempore distinctio ducimus nesciunt eius? Dolorum, dolorem? Ipsam modi enim dignissimos autem ad cum nobis voluptatibus consequatur molestias totam unde, dolorum perspiciatis natus.</p>
          }
          </div>
        </div>
     
        <div className="">
          <p className=" font-dmfont text-[16px] font-normal text-[#767676] py-[19px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
        </div>
      </div>
      <div className="w-[20%] mt-[123px] mb-[45px]">
            <div className="flex justify-between">
               <h5 className="text-[20px] font-dmfont font-normal text-[#767676]">Description</h5>
               <h5 className="text-[20px] font-dmfont font-bold">Reviews (1)</h5>
            </div>
      </div>
      <div className="w-[100%]">
        <div className=" border-b-[1px] border-[#F0F0F0] pb-[16px]">
          <p className="text-[14px] text-[#767676] font-dmfont font-normal pb-[16px]">1 review for Product</p>
          <div className="flex items-center border-t-[1px] border-[#F0F0F0] pt-[16px]">
           ...
           <p className="text-[16px] text-[#767676] font-dmfont font-normal pt-[20px]">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
        </div>
